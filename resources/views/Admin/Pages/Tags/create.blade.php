        ...
        <form action="{{ route('admin.tags.store') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('نام تگ را وارد کنید') }}" value="{{ old('name')}} " />
                </div>
                {{-- end brand name --}}
                {{-- select is active --}}
                <div class="col">
            ...
            {{-- button --}}
            <div class="my-4">
                <button class="btn btn-md btn-primary" type="submit">{{ __('ثبت تگ') }}</button>
