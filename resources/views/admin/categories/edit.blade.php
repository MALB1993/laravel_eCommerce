...
@section('content')
    <div class="col-md-12">
        <div class="d-sm-flex align-items-center justify-content-between mb-4 bg-white p-2 shadow rounded">
            ...
            <a href="{{ route('admin-panel.categories.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <form action="{{ route('admin-panel.categories.update',['category' => $category->id]) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="name" id="name" placeholder="{{ __('Write your brand name') }}" value="{{ $category->name }}" class="form-control @error('name') is-invalid @enderror">
                        @error('name')
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="slug" id="slug" placeholder="{{ __('Write your category slug') }}" value="{{ $category->slug }}" class="form-control @error('slug') is-invalid @enderror">
                        @error('slug')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select id="attributeIsFilterSelect"  name="attribute_is_filter_ids[]" class="form-control @error('attribute_is_filter_ids') is-invalid @enderror" multiple>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="selectpicker @error('variation_id') is-invalid @enderror" name="is_variation" id="variationSelect">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="icon" id="icon" placeholder="{{ __('Write your icon class') }}" value="{{ $category->icon }}" class="form-control @error('icon') is-invalid @enderror" dir="auto">
                        @error('icon')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description" cols="30" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="{{ __('Write Description') }}">{{ $category->description }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
